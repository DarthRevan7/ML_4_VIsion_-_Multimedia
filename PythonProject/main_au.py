...
start_epoch     = 15      # indice 0-based: riparte da epoca 16
n_epochs        = 20      # totale epoche (15 già fatte + 5 nuove)
...
save_name     = f"logonet_resnet50_margin04_E{n_epochs}_LR_decay_aug.pth"
save_name_csv = f"training_log_margin04_E{n_epochs}_LR_decay_aug.csv"
